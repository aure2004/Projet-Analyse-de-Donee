...
selected_columns = [
    ...
    "host_identity_verified", "cancellation_policy", "property_type",
...
numerical_transformer = Pipeline(steps=[
    ('imputer', SimpleImputer(strategy='median')),  # Remplir les NaN avec la médiane
    ('scaler', StandardScaler())  # Normalisation
])

categorical_transformer = Pipeline(steps=[
    ('imputer', SimpleImputer(strategy='constant', fill_value='missing')),  # Remplir les NaN avec 'missing'
...
# Prédictions finales sur le fichier de test
